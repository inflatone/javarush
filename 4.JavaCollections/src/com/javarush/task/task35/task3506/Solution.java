...
public class Solution {
    ...
    public static <E> void add(List<? super E> destinationList, List<? extends E> sourceList) {
        ListIterator<? super E> destListIterator = destinationList.listIterator();
        ListIterator<? extends E> srcListIterator = sourceList.listIterator();
